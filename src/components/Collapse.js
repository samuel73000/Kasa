    ...
    return (
      <section>
        <div>
          {isOpen[0] ? (
            <div>
              <button onClick={() => toggleCollapse(0)} className="collapse-btn collapse-fleche-ani ">
                Fiabilité
                <FontAwesomeIcon icon={faChevronDown} className="collapse-fleche" />
              </button>
              <p className="collapse-texte">
        ...
        <div>
          {isOpen[1] ? (
            <div>
              <button onClick={() => toggleCollapse(1)} className="collapse-btn collapse-fleche-ani">
              Respect
              <FontAwesomeIcon icon={faChevronDown} className="collapse-fleche" />
              </button>
        ...
        <div>
          {isOpen[2] ? (
            <div>
              <button onClick={() => toggleCollapse(2)} className="collapse-btn collapse-fleche-ani">
              Service
              <FontAwesomeIcon icon={faChevronDown} className="collapse-fleche" />
              </button>
        ...
        <div>
          {isOpen[3] ? (
            <div>
              <button onClick={() => toggleCollapse(3)} className="collapse-btn collapse-fleche-ani">
              Sécurité
              <FontAwesomeIcon icon={faChevronDown} className="collapse-fleche" />
              </button>
